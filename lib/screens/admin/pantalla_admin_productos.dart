                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        maxLines: 3,
                        validator: (v) => (v == null || v.isEmpty) ? 'You must enter a description' : null,
                      ),
                      SizedBox(height: 16),
                      TextFormField(
                        ...
                        validator: (v) {
                          if (v == null || v.isEmpty) return 'You must enter a price';
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Product $newTitle updated')),
                    );
                  },
